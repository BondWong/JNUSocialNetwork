        ...
        <div class="layer">
          ...
          <div class="displayBody">
            ...
            <div class="containerReg" style="display: block">
              <div class="regBox">
                <form class="form-signin" role="form" method="post" action="../security/RegServlet">
                  <p>
                    <input type="text" class="form-control" placeholder="请输入教务系统ID" name="ID" data-errormessage-value-missing="请输入教务处学号" required autofocus maxLength="20" />
                  </p>
                  <p>
                    <input type="password" class="form-control" placeholder="请输入教务系统密码" name="password" data-errormessage-value-missing="请输入教务处密码" required maxLength="20" />
                  </p>
                  <div class="form-cust">
                    <input type="text" class="form-control form-control-cust" placeholder="请输入验证码" name="valCode" maxLength="4" pattern="[A-Za-z0-9]{4}" data-errormessage-value-missing="请输入验证码" data-errormessage-pattern-mismatch="验证码错误" required />
                    <div class="form-cust-img">
                      <img src="../security/RegServlet" onload="javascript:finish_loading_valcode();" id="register_valcode_image" style="display: none" />
                      <img src="images/register_loading_valcode.gif" id="register_loadingvalcode_image" />
                    </div>
                  </div>
                  ...
                  <button class="btn btn-lg btn-success btn-block signUpBtn" type="submit">注册</button>
                  <h4>
                已有账号？<span class="btn signIn">登录</span>
              </h4>
                </form>
                <div id="register_fail" class="alert alert-danger" style="display: none"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <c:choose>
          <c:when test='${param.error == "VALCODEERROR"}'>
            <script type="text/javascript">
              ...
              setTimeout('$("#regiter_fail").fadeOut("slow")',
                3000);
            </script>
          </c:when>
          <c:when test='${param.error == "IDORPAERROR"}'>
            <script type="text/javascript">
              ...
              $("#register_fail").fadeIn("fast");
              setTimeout('$("#register_fail").fadeOut("slow")',
                3000);
            </script>
          </c:when>
