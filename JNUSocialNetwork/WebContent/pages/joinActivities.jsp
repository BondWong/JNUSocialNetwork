...
<!-- Bootstrap core CSS -->
<link href="styles/bootstrap-3.2.0-dist/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body container">
					...
					<div class="col-xs-6 text-center">
						<a class="btn btn-primary btn-long account-link"
							href="account.jsp?nav=regTab">注册</a>
					</div>
					<div class="col-xs-6 text-center">
						<a class="btn btn-success btn-long account-link"
							href="account.jsp">登录</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body container">
					<form class="form-inline text-center" role="form">
						<input id="telnum" type="tel" class="form-control" maxlength="11"
							autofocus />
	...
	<div id="successAlert"
		class="col-xs-10 col-md-8 col-xs-offset-1 col-md-offset-2 alert alert-success alert-dismissible container react-alert"
		role="alert">
	...
	<div id="errorAlert"
		class="col-xs-10 col-md-8 col-xs-offset-1 col-md-offset-2 alert alert-danger alert-dismissible container react-alert"
		role="alert">
		<button type="button" class="close" data-dismiss="alert">
			<span aria-hidden="true">&times;</span> <span class="sr-only">Close</span>
		</button>
