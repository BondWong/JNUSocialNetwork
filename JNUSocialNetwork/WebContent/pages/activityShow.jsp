  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
      ...
      <div class="container container_actvity">
        <div class="activityHead">
          ...
          <div class="activityInfo">
            ...
            <div class="activityShare">
              ...
              <button class="btn btn-default editActivity" data-toggle='modal' data-target='#editActivity'>管理活动</button>
              <button class="btn btn-default activityPhoto" data-toggle='modal' data-target='#addActivityPhoto'>添加活动图片</button>
        ...
        <div class="modal fade" id="editActivity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <form class="activityForm banner-form" enctype="multipart/form-data" onsubmit="return false;">
                <div class="modal-body modalBody">
                  ...
                  <div class="activityItem">
                    <div id="fail_popover" class="alert alert-danger" style="width: 81%; text-align: center; padding: 0px; display: none;">请输入时间！</div>
                  </div>
                  <div class="activityItem">
                  ...
                  <div class="activityItem">
                    <span>活动地点：</span> 
                    <input class="form-control activityInput" placeholder="" id="activityAddr" required autofocus maxLength="150" style="resize: none;" />
                  </div>
                  <div class="activityItem">
                    <span>活动细节：</span>
                    <textarea type="text" class="form-control activityInput" placeholder="" id="activityMore" required autofocus maxLength="200" style="resize: none;"></textarea>
                  </div>
                  <div class="activityItem">
                    <span>活动类型：</span> 
                  ...
                  <div class="activityItem">
                    ...
                    <div class="banner-upload">
                      ...
                      <input class="banner-input" id="fileupload" type="file" name="banner1_file" accept="image/jpeg,image/png">
                      </span>
                ...
                <div class="modal-footer">
                  ...
                  <button type="sumbit" class="btn btn-primary" id="saveActivity" value="upload">保存</button>
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
        ...
        <div class="modal fade" id="addActivityPhoto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              ...
              <form class="activityPhotoForm" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                  <button type="button" class="btn btn-primary addActivityPhoto" value="upload">保存</button>
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
          ...
          <div class="aBodyLeft">
            ...
            <div class="activityPhotos">
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <a class="left carousel-control" href="#myCarousel" data-slide="prev"><span
							class="glyphicon glyphicon-chevron-left"></span></a>  <a class="right carousel-control" href="#myCarousel" data-slide="next"><span
            ...
            <div class="aBodyComment commentBtn">
              <div class="aCommentItem">
                ...
                <div class="col-lg-6">
                  <input type="text" placeholder="发条评论" class="form-control acBtn" id="commentText1407032926865" />
                </div>
                <div class="col-lg-3">
                  <button type="button" class="btn btn-success" id="addComment" value="">发送</button>
                </div>
              </div>
            </div>
          </div>
