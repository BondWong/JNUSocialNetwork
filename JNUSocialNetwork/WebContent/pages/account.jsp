...
<body>
  ...
  <div class="regBody">
    <div class="layer">
      <div class="regTop">
        <a href="home.jsp" class="btn btn-primary btn-sm rl-button-span" role="button"><span>回到首页</span></a>  <a href="aboutUs.jsp" class="btn btn-primary btn-sm rl-button-text" role="button"><span>关于我们</span></a>
      </div>
        ...
        <div class="tab-content container-fluid">
          ...
          <div class="tab-pane fade in active" id="login">
            <form class="form-signin" role="form" method="post" action="/security/Login">
              <input type="text" class="form-control no-bottom-radius" placeholder="请输入ID" name="ID" pattern="\d{11}" data-errormessage-pattern-mismatch="ID格式不正确" data-errormessage-value-missing="请输入ID" maxlength="11" required autofocus />
              <input type="password" class="form-control no-top-radius" placeholder="请输入密码" name="bPassword" id="md5Password" pattern="\S{6}\S*" data-errormessage-value-missing="请输入密码" data-errormessage-pattern-mismatch="密码格式不正确" required maxlength="20" />
          ...
          <div class="tab-pane fade" id="common-reg">
            <form class="form-signin form" role="form" method="post" action="/security/RegServlet">
              <input class="form-control  no-bottom-radius" type="text" placeholder="请输入教务系统ID" name="ID" pattern="\d{10}" data-errormessage-value-missing="请输入教务处学号" data-errormessage-pattern-mismatch="学号格式不正确" required autofocus/>
              <input class="form-control  no-radius" type="password" placeholder="请输入教务系统密码" name="password" pattern="\S{6}\S*" maxlength="20" data-errormessage-value-missing="请输入教务处密码" data-errormessage-pattern-mismatch="密码格式不正确" required/>
