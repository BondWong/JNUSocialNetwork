...
function aboutClickEvent() {
	if (sessionStorage.getItem("otherUserID") == USERID) {
		$('body')
				.on(
						'click',
						'.aEditbtn',
...
// show photos
function showPhotos() {
	var response = FetchUserByID(sessionStorage.getItem("otherUserID"));
...
function showFollowees() {
	var response = FetchFollowees(sessionStorage.get("otherUserID"), "0", "5");
...
function showFollowers() {
	var response = FetchFollowers(sessionStorage.get("otherUserID"), "0", "5");
...
function fetchPostsByOwner() {
	var response = FetchPostsByOwner(sessionStorage.getItem("otherUserID"),
			"0", "5");
...
function fetchUserByID() {
	var userInfo = FetchUserByID(sessionStorage.getItem("otherUserID"));
