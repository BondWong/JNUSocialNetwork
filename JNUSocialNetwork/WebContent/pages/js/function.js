...
function addPost(ownerID, ownerNickName, publishDate, content, ID, likeNum) {
	...
	var boarddiv = "<div class='post "
			...
			+ ID + ">Submit</button></div></div>" + comment
			+ "</div></div></div>";
									...
									.hover(
											function() {
												...
												if (data != "") {
													...
													// class="popTip"><div
													// class="content"><div
													// class="urserBgShort"><img
													// src="images/urseBgShort.jpg"
													// /></div><div
													// class="urserInfShort"><img
													// src="images/user_img4.jpg"
													// /><p><h1>Bond</h1></p><p>
													// a good guy</p><button
													// id="followBtn">Follow</button></div></div></div>';
													var tipFrame = '<div id="'
															+ data.ID
															+ '" class="popTip"><div class="content"><div class="urserBgShort"><img src="images/urseBgShort.jpg" /></div><div class="urserInfShort"><img src="images/user_img4.jpg" /><p><h1>'
													...
													// Make sure that the
													// tooltip has absolute
													// positioning and a high
													// z-index,
													// then place it at the
													// correct spot and fade it
													// in.
											...
											function() {
												// Fade the tooltip out once the
												// mouse moves away and then
