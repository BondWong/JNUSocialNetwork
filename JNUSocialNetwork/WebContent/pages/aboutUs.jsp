...
<link href="styles/jquery.fullPage.css" rel="stylesheet">
	...
	<div id="fullpage">
			...
			<div class="slide" id="slide1">
				<div class="vertical-center">
					...
					<div class="container col-md-10 col-md-offset-1 imgset">
						<div class="col-md-2">
							<img src="images/founder-avatar/hjb.png" class="round icon-like"
								alt="hjb.png" />
						</div>
						<div class="col-md-2">
		...
		<div class="section" id="section2">
			<div class="wwa">
				...
				<p class=" ">我们是一支平凡的团队</p>
				<p class=" ">我们来自暨南大学</p>
				<p class=" ">致力打造全新校园社区</p>
				<p class=" ">创造缤纷多彩的校园生活</p>
				<p class=" ">我们期待着大家支持</p>
				<p class=" ">CampuSite，有着一颗不平凡的心</p>
			</div>
		</div>
		<!-- section2 end -->
