...
public class UAgentInfo {
	...
	public boolean detectMaemoTablet() {
		return (userAgent.indexOf(maemo) != -1 || (userAgent
				.indexOf(maemoTablet) != -1 && userAgent.indexOf(linux) != -1));
	}
	...
	public boolean detectMobileLong() {
		return detectMobileQuick() || detectMaemoTablet()
				|| detectGameConsole();
	}
	...
	public boolean detectMSIE6() {
		return userAgent.indexOf(msie60) != -1
				&& userAgent.indexOf(msie61) != -1;
	}
	...
	public boolean detectTierOtherPhones() {
		return detectMobileQuick() && (!detectTierIphone())
