...
public class MessageStorage {
	...
	public void addMessage(Map<String, Object> message) {
		if(this.messagesQueueMap.get(message.get("fromID")) == null)
			this.messagesQueueMap.put((String)message.get("fromID"), new LinkedList<Map<String, Object>>());
	...
	public void updateMessageStatus(Map<String, Object> params) {
		...
		for(Map<String, Object> message : this.messagesQueueMap.get(params.get("fromID"))) {
