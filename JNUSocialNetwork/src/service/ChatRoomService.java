...
public class ChatRoomService {
	...
	public Response fetchChatRoom(@PathParam("ID1") String ID1, @PathParam("ID2") String ID2) throws Exception {
	...
	public Response fetchMessages(@PathParam("chatRoomID") String chatRoomID, 
			@PathParam("startSize") int startIndex, @PathParam("pageSize") int pageSize) throws Exception {
		transaction = new FetchMessagesTransaction();
		List<Map<String, Object>> results;
		try {
			results = (List<Map<String, Object>>) transaction.execute(chatRoomID, startIndex, pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			throw e;
