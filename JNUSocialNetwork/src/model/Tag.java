...
@NamedQueries(value = { @NamedQuery(name = "Tag.fetchHeatLookingFor", query = "SELECT t FROM Tag t WHERE SIZE(t.activityTypeUsers) = 0 AND SIZE(t.lookingForUsers) !=0 ORDER BY SIZE(t.lookingForUsers) DESC") })
