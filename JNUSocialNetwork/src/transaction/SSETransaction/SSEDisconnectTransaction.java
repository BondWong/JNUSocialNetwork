...
public class SSEDisconnectTransaction extends ServerSentEventTransaction{
	...
	protected ServerSentEvent getServerSentEvent(Object data) {
		// TODO Auto-generated method stub
		ServerSentEvent sse = ModelFactory.getInstance().create(ServerSentEvent.class, SSEType.DISCONNECT ,data);
		return sse;
	}
